...
#define nrn_init _nrn_init__Nap_Et2_2F
#define _nrn_initial _nrn_initial__Nap_Et2_2F
#define nrn_cur _nrn_cur__Nap_Et2_2F
#define _nrn_current _nrn_current__Nap_Et2_2F
#define nrn_jacob _nrn_jacob__Nap_Et2_2F
#define nrn_state _nrn_state__Nap_Et2_2F
#define _net_receive _net_receive__Nap_Et2_2F 
#define rates rates__Nap_Et2_2F 
#define states states__Nap_Et2_2F 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_Nap_Et2_2F", _hoc_setdata,
 "rates_Nap_Et2_2F", _hoc_rates,
 0, 0
};
 ...
 "gNap_Et2bar_Nap_Et2_2F", "S/cm2",
 "ina_Nap_Et2_2F", "mA/cm2",
 "gNap_Et2_Nap_Et2_2F", "S/cm2",
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Nap_Et2_2F E:/Code/dendrites_pasticity/mod_stochastic/Nap_Et2_2F.mod\n");
...
static int  rates (  ) {
 ...
 _lqt = pow( 2.3 , ( ( 34.0 - 21.0 ) / 10.0 ) ) ;
   ...
   SDm = sqrt ( fabs ( mInf * ( 1.0 - m ) / mTau + ( 1.0 - mInf ) / mTau * m ) / ( 0.05 * NNap_Et2 * 3.0 ) ) ;
   if ( v  == - 17.0 ) {
     v = v + 0.0001 ;
     }
   if ( v  == - 64.4 ) {
   ...
   SDh = sqrt ( fabs ( hInf * ( 1.0 - h ) / hTau + ( 1.0 - hInf ) / hTau * h ) / ( 0.05 * NNap_Et2 ) ) ;
     return 0; }
 ...
 v=_v;
{
  ena = _ion_ena;
 { error =  states();
 if(error){fprintf(stderr,"at line 46 in file Nap_Et2_2F.mod:\n	SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "Nap_Et2_2F.mod";
static const char* nmodl_file_text = 
