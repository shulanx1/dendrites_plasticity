...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 K_Tst_2F E:/Code/dendrites_pasticity/mod_stochastic/K_Tst_2F.mod\n");
...
static int  rates (  ) {
 ...
 _lqt = pow( 2.3 , ( ( 34.0 - 21.0 ) / 10.0 ) ) ;
   ...
   SDm_1 = sqrt ( fabs ( mInf * ( 1.0 - m ) / mTau + ( 1.0 - mInf ) / mTau * m ) / ( 0.05 * NK_Tst * 4.0 ) ) ;
   SDh_1 = sqrt ( fabs ( hInf * ( 1.0 - h ) / hTau + ( 1.0 - hInf ) / hTau * h ) / ( 0.05 * NK_Tst ) ) ;
   v = v - 10.0 ;
     return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "K_Tst_2F.mod";
static const char* nmodl_file_text = 
