...
def plot_grad_example(f_e, f_i, e_ind, i_ind, s_e, s_i, t_window, i_positions,
    ...
    ax1.set_yticks([1, 200, 400, 600, 800, 1000, 1200])
    ax1.set_yticklabels([1, 200, 400, 600, 800, 1000, 1200])
    ax2.set_yticks([1, 200, 400, 600, 800, 1000, 1200])
    ax2.set_yticklabels([1, 50, 100, 150, 200, 250, 300], color='m')
